                    ...
                    <div class="form-group col-md-12 col-lg-3" >
                     ...
                     <div class="form-group col-md-12 col-lg-2">
                        <label for="name">Client Unique ID</label>
                            <input id="uid" name="uid" value="<?php if(isset($_GET['uid'])) echo $_GET['uid']; ?>" class="form-control"  type="text">
                    </div>
                    <div class="form-group col-md-12 col-lg-2">
        ...
        <div class="cal-icon2"><img src="img/vew.png" width="22" alt="calender-icon"></div></div>
                    ...
                    <div class="form-group col-md-12 col-lg-3">
                        ...
                        <div id="apDiv1">255</div>
                            <input maxlength="7" value="<?php if(isset($_GET['phone'])) echo $_GET['phone']; ?>" id="phone" name="phone" class="form-control-number" type="text">
                    </div>
                 ...
                 ?>
                  <tr class="<?=$rwclass?>">
                    ...
                    ->orderBy('treatment_id','desc')->first();
                     ...
                     <?php
                     $order_lab_test = DB::table('order_lab_work')
                     ->select('created_at')
                     ->where('client_id',$res->client_id)
                     ->orderBy('order_lab_work_id','desc')->first();
                      ?>
                     <td <?=$bg?>><?=date("m/d/Y", strtotime($order_lab_test->created_at));?></td>
                     <?php
                         $labres = DB::table('lab_results')
                         ->select('hiv_viral_load_results')
                         ->where('client_id',$res->client_id)
                         ->orderBy('created_at','desc')->first();
                      ?>
                      <td <?=$bg?>><?=$labres->hiv_viral_load_results?></td>
                      <td <?=$bg?>>
                          <?php
                              if($res->gender == 'M'){
                                echo 'Male';
