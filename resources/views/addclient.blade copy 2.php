      ...
      <div class="row">
        ...
        <div class="col-md-3 col-md-offset-1">
          <div class="form-group">
            ...
            <input class="form-control-n required" name="client_name" id="client_name" />
          </div>
        </div>
        <div class="col-md-2 col-md-offset-1">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="col-md-7" style="padding:">
                          ...
                          <input id="phone" name="phone" maxlength="9" class="form-control-new required" type="text" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="col-md-7"><input  value="<?=Auth::user()->facility_ctcno?>" class="form-control-n" type="text" readonly /></div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="col-md-5 control-label line-h" >Facility Name</label>
                        <div class="col-md-7"><input value="<?=Auth::user()->facility_name?>" class="form-control-n" type="text" readonly /></div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
...
Shipped to Lab</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6">
                          <input value="<?=$clinic->clinic_name?>" id="lab_name" class="form-control-n"  type="text">
                        </div>
                      </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="clearfix"></div>
                      <div class="form-group" id="date_of_reporting">
                        <label id="reported_date_label" class="col-md-3 control-label" style="margin-top:8px;">Date of Reporting</label>
                        <div class="col-md-6">
                          <input id="reported_date" class="form-control-n" style="width:79%;" type="text" disabled>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12 text-center">
                ...
                <div class="tab-pane fade" id="discharge">
                  ...
                  <div class="row" id="discharge_reason">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label id="discharge_reason_ip_label" class="col-md-2 control-label client-details" style="margin-top:5px;" >Reason of Discharge</label>
                        <div class="col-md-8">
    ...
    $('#form2').submit(function(e){
      ...
      $('#form3').submit(function(e){
          ...
          $.ajax
            ({
              type: "POST",
              url: "{{ url('/savetreatmentlabwork') }}",
              data: '_token=<?php echo csrf_token(); ?>&sample_collection_date='+$('#rangepicker6').val()+'&test_reason='+$('#test_reason').val()+'&collected_by='+$('#collected_by').val()+'&sample_shipped_date='+$('#rangepicker8').val()+'&test_requested_by='+$('#test_requested_by').val()+'&counseling='+$("#counseling").val()+'&sample_type='+$("#sample_type").val(),
              cache: false,
              async:false,
              success: function(data)
              {
