      ...
      <div class="row">
        ...
        <div class="col-md-3 col-md-offset-1">
          <div class="form-group">
            ...
            <input class="form-control-n required" name="client_name" id="client_name" value="<?=$clientdetails->name?>" />
          </div>
        </div>
        <div class="col-md-2 col-md-offset-1">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="col-md-7" style="padding:">
                          ...
                          <input id="phone" name="phone" maxlength="9" class="form-control-new required" type="text" value="<?=$clientdetails->phone?>"/>
                        </div>
                      </div>
                    </div>
                    <?php
  ...
  $('#firststep').click(function(e){
    ...
    var tb_medication = $("#tb_medication").val();
      ...
      $.ajax
        ({
          type: "POST",
          url: "<?php echo e(url('/updateclientdetails')); ?>",
    ...
    $('#form2').submit(function(e){
        ...
        $.ajax
          ({
            type: "POST",
            url: "<?php echo e(url('/addtreatment')); ?>",
      ...
      $('#form3').submit(function(e){
          ...
          $.ajax
            ({
              type: "POST",
              url: "<?php echo e(url('/addtreatmentlabwork')); ?>",
      ...
      $('#form4').submit(function(e){
          ...
          $.ajax
            ({
              type: "POST",
              url: "<?php echo e(url('/addlabresults')); ?>",
        ...
        $('#form5').submit(function(e){
            ...
            $.ajax
              ({
                type: "POST",
                url: "<?php echo e(url('/updatedischarge')); ?>",
