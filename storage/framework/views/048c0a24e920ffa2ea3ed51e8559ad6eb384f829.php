                ...
                <div class="col-sm-10" >
                  ...
                  <?php if($paginator->lastPage() > 1): ?>
                      <ul class="pagination pull-left">
                          ...
                          <li class="paginate_button previous <?php echo e(($paginator->currentPage() == 1) ? ' disabled' : ''); ?>" id="inline_edit_previous"><a href="<?php echo e($paginator->url(1)); ?>" aria-controls="inline_edit" data-dt-idx="0" tabindex="0">FIRST</a></li>
                                <li class="paginate_button previous <?php echo e(($paginator->currentPage() == 1) ? ' disabled' : ''); ?>" id="inline_edit_previous"><a href="<?php echo e($paginator->url($paginator->currentPage()-1)); ?>" aria-controls="inline_edit" data-dt-idx="0" tabindex="0">PREV</a></li>
                                ...
                                ?>
                                  <?php if($from < $i && $i < $to): ?>
                                    <li class="paginate_button <?php echo e(($paginator->currentPage() == $i) ? ' active' : ''); ?>">
                                        <a href="<?php echo e($paginator->url($i)); ?>" aria-controls="inline_edit" data-dt-idx="1" tabindex="0"><?php echo e($i); ?></a>
                                    </li>
                                  <?php endif; ?>
                              <?php endfor; ?>
                                <li class="paginate_button next <?php echo e(($paginator->currentPage() == $paginator->lastPage()) ? ' disabled' : ''); ?>" id="inline_edit_next"><a href="<?php echo e($paginator->url($paginator->currentPage()+1)); ?>" aria-controls="inline_edit" data-dt-idx="4" tabindex="0">NEXT</a></li>

                                <li class="paginate_button next <?php echo e(($paginator->currentPage() == $paginator->lastPage()) ? ' disabled' : ''); ?>" id="inline_edit_next"><a href="<?php echo e($paginator->url($paginator->lastPage())); ?>" aria-controls="inline_edit" data-dt-idx="4" tabindex="0">LAST</a></li>
                          </ul>
                      <?php endif; ?>
                </div>
                  </div>
...
$("#phone").keydown(function(event) {
    ...
    $('#show').change(function(){
        ...
        if(fname != null && uid != null && dob != null && phone != null){
            window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&uid='+uid+'&dob='+dob+'&phone='+phone+'&lists='+val;
        }else if(fname != null && uid != null && dob != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&uid='+uid+'&dob='+dob+'&lists='+val;
        }else if(fname != null && uid != null && phone != null){
            window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&uid='+uid+'&phone='+phone+'&lists='+val;
        }else if(fname != null && phone != null && dob != null){
            window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&dob='+dob+'&phone='+phone+'&lists='+val;
        }else if(uid != null && phone != null && dob != null){
            window.location.href = '<?php echo e(Request::url()); ?>?uid='+uid+'&dob='+dob+'&phone='+phone+'&lists='+val;
        }else if(fname != null && uid != null){
            window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&uid='+uid+'&lists='+val;
        }else if(fname != null && dob != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&dob='+dob+'&lists='+val;
        }else if(fname != null && phone != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&phone='+phone+'&lists='+val;
        }else if(dob != null && uid != null){
          window.location.href = '<?php echo e(Request::url()); ?>?uid='+uid+'&dob='+dob+'&lists='+val;
        }else if(phone != null && uid != null){
          window.location.href = '<?php echo e(Request::url()); ?>?uid='+uid+'&phone='+phone+'&lists='+val;
        }else if(phone != null && fname != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&phone='+phone+'&lists='+val;
        }else if(phone != null && dob != null){
          window.location.href = '<?php echo e(Request::url()); ?>?dob='+dob+'&phone='+phone+'&lists='+val;
        }else if(fname != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&lists='+val;
        }else if(uid != null){
          window.location.href = '<?php echo e(Request::url()); ?>?uid='+uid+'&lists='+val;
        }else if(dob != null){
          window.location.href = '<?php echo e(Request::url()); ?>?dob='+dob+'&lists='+val;
        }else if(phone != null){
          window.location.href = '<?php echo e(Request::url()); ?>?phone='+phone+'&lists='+val;
        }else {
          window.location.href = '<?php echo e(Request::url()); ?>?lists='+val;
        }
    ...
    $('#seeall').click(function(){
      ...
      if(fname != null && uid != null && dob != null && phone != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&uid='+uid+'&dob='+dob+'&phone='+phone+'&lists=all';
      }else if(fname != null && uid != null && dob != null){
        window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&uid='+uid+'&dob='+dob+'&lists=all';
      }else if(fname != null && uid != null && phone != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&uid='+uid+'&phone='+phone+'&lists=all';
      }else if(fname != null && phone != null && dob != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&dob='+dob+'&phone='+phone+'&lists=all';
      }else if(uid != null && phone != null && dob != null){
          window.location.href = '<?php echo e(Request::url()); ?>?uid='+uid+'&dob='+dob+'&phone='+phone+'&lists=all';
      }else if(fname != null && uid != null){
          window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&uid='+uid+'&lists=all';
      }else if(fname != null && dob != null){
        window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&dob='+dob+'&lists=all';
      }else if(fname != null && phone != null){
        window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&phone='+phone+'&lists=all';
      }else if(dob != null && uid != null){
        window.location.href = '<?php echo e(Request::url()); ?>?uid='+uid+'&dob='+dob+'&lists=all';
      }else if(phone != null && uid != null){
        window.location.href = '<?php echo e(Request::url()); ?>?uid='+uid+'&phone='+phone+'&lists=all';
      }else if(phone != null && fname != null){
        window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&phone='+phone+'&lists=all';
      }else if(phone != null && dob != null){
        window.location.href = '<?php echo e(Request::url()); ?>?dob='+dob+'&phone='+phone+'&lists=all';
      }else if(fname != null){
        window.location.href = '<?php echo e(Request::url()); ?>?fname='+fname+'&lists=all';
      }else if(uid != null){
        window.location.href = '<?php echo e(Request::url()); ?>?uid='+uid+'&lists=all';
      }else if(dob != null){
        window.location.href = '<?php echo e(Request::url()); ?>?dob='+dob+'&lists=all';
      }else if(phone != null){
        window.location.href = '<?php echo e(Request::url()); ?>?phone='+phone+'&lists=all';
      }else {
        window.location.href = '<?php echo e(Request::url()); ?>?lists=all';
      }
